      ...
      <div tw="mr-4">
        <button
          ...
          css={[
            ...
            !field.value &&
              tw`bg-gray-200 dark:bg-gray-500 hover:bg-gray-300 hover:dark:bg-gray-400 text-gray-600 dark:text-gray-700`,
          ]}
        >
          <TiTick />
        </button>
      </div>
      <div tw="flex-grow">{description && <div tw="text-sm text-gray-700 dark:text-gray-300">{description}</div>}</div>
    </label>
  )
}
